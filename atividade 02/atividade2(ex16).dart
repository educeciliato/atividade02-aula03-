...
class UnidadeMedida {
  ...
  UnidadeMedida({required this.nome, required this.simbolo, required this.atualizarUnidade});
}
...
void main() {
  ...
  var enderecoFornecedor =
      Endereco(rua: "Rua Fornecedor", cep: "12345-678", cidade: cidade);
  ...
  var tipoProduto = TipoProduto(
    "Eletrônico",
    exibirTipo: () => print("Tipo de produto exibido."),
  );

  var categoriaProduto = CategoriaProduto(
    "Tecnologia",
    "Produtos tecnológicos",
    exibirCategoria: () => print("Categoria exibida."),
  );
  ...
  var pedidoCompraAtraso = PedidoCompraAtraso(
    ...
    verificarAtraso: (prevista, real) {
      var atraso = real.difference(prevista).inDays;
      if (atraso > 0) {
  ...
  print(
      "Pedido de Compra do Fornecedor: ${pedidoCompraAtraso.pedidoCompra.fornecedor.nome}");
  print(
      "Data prevista para entrega: ${pedidoCompraAtraso.dataEntregaPrevista}");
  print("Data real de entrega: ${pedidoCompraAtraso.dataEntregaReal}");

  // Chamando a função de verificar atraso
  pedidoCompraAtraso.verificarAtraso(
    pedidoCompraAtraso.dataEntregaPrevista,
    pedidoCompraAtraso.dataEntregaReal,
  );
}
